import type { WorkspaceDescriptor, WorkspaceFolderEntry } from './workspace-descriptor';
import type { WorkspaceWatchEvent, WorkspaceWatchEventType } from './workspace-watcher';
