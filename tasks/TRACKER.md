...
| [ ] | IDE-202 | Professional theme token expansion | Angular Workbench Shell | frontend | Foundation | P0 | Yes | Blocked until IDE-198, IDE-199, IDE-200 | Verification: Theme registry/unit snapshots + editor/terminal integration tests | Docs/API: docs/ui-kit/theme-system for IDE-202 |
| [ ] | IDE-199 | Theme runtime + token pipeline | Angular Workbench Shell | frontend | Foundation | P0 | Yes | Blocked until IDE-017, IDE-106, IDE-198 | Verification: Theme switching unit tests + Playwright shell smoke | Docs/API: docs/ui-kit/theme-system for IDE-199 |
...
| [ ] | IDE-114 | Accessibility pass | UX / Productivity Enhancements | frontend | Foundation | P0 | Yes | Blocked until IDE-017 | Verification: UX Playwright suite + Axe scans | Docs/API: docs/ux for IDE-114 |
...
| [ ] | IDE-117 | Telemetry platform | Observability / Reliability | infra | Foundation | P0 | Yes | Blocked until IDE-005, IDE-008 | Verification: Telemetry replay + health dashboards | Docs/API: docs/observability for IDE-117 |
...
| [ ] | IDE-119 | Crash reporting abstraction | Observability / Reliability | infra | Foundation | P0 | Yes | Blocked until IDE-015 | Verification: Telemetry replay + health dashboards | Docs/API: docs/observability for IDE-119 |
...
| [ ] | IDE-121 | Feature flag framework | Observability / Reliability | infra | Foundation | P0 | Yes | Blocked until IDE-005 | Verification: Telemetry replay + health dashboards | Docs/API: docs/observability for IDE-121 |
