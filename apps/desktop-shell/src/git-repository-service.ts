...
import { GitRepositoryManager } from '@nexus/platform/git/git-repository-manager';
import type { GitRepository } from '@nexus/platform/git/git-types';
import { GitCommitService } from '@nexus/platform/git/git-commit-service';
import { GitStatusService } from '@nexus/platform/git/git-status-service';
