...
export const WORKBENCH_I18N_BUNDLES: TranslationBundle[] = [
  {
    ...
    entries: {
      ...
      'accessibility.skip.editor': 'Skip to editor',
      'accessibility.landmark.activityBar': 'Workbench activity bar',
      'accessibility.landmark.primarySidebar': 'Primary sidebar',
      'accessibility.landmark.secondarySidebar': 'Secondary sidebar',
      'accessibility.landmark.editor': 'Editor area',
      'accessibility.landmark.panel': 'Workbench panel',
      'accessibility.landmark.statusBar': 'Workbench status bar',
      'accessibility.group.activities': 'Workbench activities',
      'accessibility.group.sidebarViews': 'Sidebar views',
      'accessibility.group.panelViews': 'Panel views',
      'accessibility.group.editorTabs': 'Editor tabs',
      'accessibility.action.hideSidebar': 'Hide sidebar',
      'accessibility.action.openSettings': 'Open settings',
      'accessibility.liveRegion.summary': 'Active view {view}. Panel {panel}. {notifications}.',
  ...
  },
  {
    ...
    entries: {
      ...
      'activity.git': 'Gestion de code source',
      'activity.run': 'Execution et debogage',
      'activity.extensions': 'Extensions',
      'activity.chat': 'IA',
      'panel.terminal': 'Terminal',
      'panel.output': 'Sortie',
      'panel.problems': 'Problemes',
      'accessibility.skip.editor': "Aller a l'editeur",
      'accessibility.landmark.activityBar': "Barre d'activites de l'atelier",
      'accessibility.landmark.primarySidebar': 'Barre laterale principale',
      'accessibility.landmark.secondarySidebar': 'Barre laterale secondaire',
      'accessibility.landmark.editor': "Zone d'edition",
      'accessibility.landmark.panel': "Panneau de l'atelier",
      'accessibility.landmark.statusBar': "Barre d'etat de l'atelier",
      'accessibility.group.activities': "Activites de l'atelier",
      'accessibility.group.sidebarViews': 'Vues de la barre laterale',
      'accessibility.group.panelViews': 'Vues du panneau',
      'accessibility.group.editorTabs': "Onglets de l'editeur",
      'accessibility.action.hideSidebar': 'Masquer la barre laterale',
      'accessibility.action.openSettings': 'Ouvrir les parametres',
      'accessibility.liveRegion.summary': 'Vue active {view}. Panneau {panel}. {notifications}.',
  ...
  },
  {
    ...
    entries: {
      ...
      'activity.git': 'Control de codigo fuente',
      'activity.run': 'Ejecucion y depuracion',
      'activity.extensions': 'Extensiones',
      'activity.chat': 'IA',
      'panel.terminal': 'Terminal',
      'panel.output': 'Salida',
      'panel.problems': 'Problemas',
      'accessibility.skip.editor': 'Ir al editor',
      'accessibility.landmark.activityBar': 'Barra de actividades del area de trabajo',
      'accessibility.landmark.primarySidebar': 'Barra lateral principal',
      'accessibility.landmark.secondarySidebar': 'Barra lateral secundaria',
      'accessibility.landmark.editor': 'Area del editor',
      'accessibility.landmark.panel': 'Panel del area de trabajo',
      'accessibility.landmark.statusBar': 'Barra de estado del area de trabajo',
      'accessibility.group.activities': 'Actividades del area de trabajo',
      'accessibility.group.sidebarViews': 'Vistas de la barra lateral',
      'accessibility.group.panelViews': 'Vistas del panel',
      'accessibility.group.editorTabs': 'Pestanas del editor',
      'accessibility.action.hideSidebar': 'Ocultar barra lateral',
      'accessibility.action.openSettings': 'Abrir configuracion',
      'accessibility.liveRegion.summary': 'Vista activa {view}. Panel {panel}. {notifications}.',
