...
- Own the managed `llama.cpp` controller lifecycle before higher-level model registry, prompt orchestration, streaming, and guardrail features are added.
...
## Next Tasks Unlocked
- `IDE-086` model discovery and registry
